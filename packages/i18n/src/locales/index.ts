...
export { default as huCore } from "./hu/core";
...
export const locales = {
  ...
  hu: {
    translations: () => import("./hu/translations"),
    accessibility: () => import("./hu/accessibility"),
    editor: () => import("./hu/editor"),
    "empty-state": () => import("./hu/empty-state"),
  },
};
